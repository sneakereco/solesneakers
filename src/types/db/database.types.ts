  ...
  public: {
    Tables: {
      ...
      checkout_notification_outbox: {
        ...
        Relationships: [
          {
            foreignKeyName: "checkout_notification_outbox_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "checkout_notification_outbox_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      email_audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_audit_log_notification_id_fkey"
            columns: ["notification_id"]
            isOneToOne: false
            referencedRelation: "checkout_notification_outbox"
            referencedColumns: ["id"]
          },
          {
      ...
      square_disputes: {
        ...
        Relationships: [
          {
            foreignKeyName: "square_disputes_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "square_disputes_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      square_refunds: {
        ...
        Relationships: [
          {
            foreignKeyName: "square_refunds_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "square_refunds_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      reserve_square_checkout_inventory_with_address: {
        Args: {
          p_cart_hash: string
          p_currency: string
          p_customer_state: string
      ...
      reserve_square_checkout_inventory_without_billing: {
        Args: {
          p_cart_hash: string
          p_currency: string
          p_customer_state: string
